...
<title><?php echo $materia;?> Apostilas (1° Bimestre)</title>
...
<div id="header-wrapper">
	<div id="header" class="container">
		<div id="logo">
			<h1><a href="index.html"><img src="images/logo.png" width="180px" height="80px"/></a></h1>
		</div>
		<div id="menu">
			<ul>
...
<div id="banner-wrapper">
	<div id="banner" class="container">
			<h1><?php echo $materia; ?> - Apostila</h1>
			<h2>(1° Bimestre)</h2>
			<h3></h3>
	</div>
</div>
